...
::: {.timeline-item}
<div class="timeline-role">Predicting US Skin Cancer Status</div>
<div class="timeline-meta">Machine learning and statistical classification</div>
Built and compared classification models on more than 50,000 observations to predict benign versus malignant skin cancer status.
:::

::: {.timeline-item}
<div class="timeline-role">Beyond the Board</div>
<div class="timeline-meta">Digital humanities and public-facing research</div>
Created a website exploring structural inequality in education through narrative writing, historical framing, and data storytelling.
:::

::: {.timeline-item}
<div class="timeline-role">Music, Exercise Intensity, and Performance</div>
<div class="timeline-meta">Experimental design and statistical inference</div>
Used factorial ANOVA to study how music and exercise intensity influence running performance and heart rate.
:::
